...
//APLICANDO FUNCION DE TECLA ENTER
document.getElementById("Ch_input_box").addEventListener("keydown", function(event) {
  if (event.key === "Enter") { // Si se presiona Enter (código 13)
...
cambiar_contacto.addEventListener('click', function(){ 
  ...
  switch(indiceFijo){
    case 0:
      modificarAbrirChat_Wsp("https://wa.me/+51901350732", 'coloring1 0.4s ease', 'rgb(7, 107, 124)')
      break;
    case 1:
      modificarAbrirChat_Wsp("https://wa.me/+51926464881", 'coloring2 0.4s ease', 'rgb(14, 112, 63)')
      break;
    case 2:
      modificarAbrirChat_Wsp("https://wa.me/+51987768632", 'coloring3 0.4s ease', 'rgb(3, 104, 89)')
      break;
  }
  indiceFijo++
  if (indiceFijo >= 3) {
